...
const COLUMNS = [
  ...
  { key: "poPrefix", label: "PO Prefix", mono: true },
  { key: "grnPrefix", label: "GRN Prefix", mono: true },
  { key: "indentPrefix", label: "Indent Prefix", mono: true }
] as const;
...
export default function Page() {
  ...
  return (
    <SimpleMasterShell title="Transaction Numbering" subtitle="PO / GRN / Indent prefixes from Tool Group master">
