...
const COLUMNS = [
  ...
  { key: "name", label: "Gauge Type", mono: false },
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    (async () => {
      setLoading(true);
      const res = await apiGet<{ items?: Row[] }>("/api/lookups/gauge-types");
      if (!cancelled) {
  ...
  return (
    <SimpleMasterShell title="Gauge Type Master" subtitle="GAUGE_TYPE — gauge classification master">
