...
/** APP-SPECIFIC — Fetches /api/dashboard/kpi groupBreakdown. See design-system-export/NOTES.md */
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] min-h-[380px]">
        {/* ── Left: light panel + donut ── */}
        <div className="bg-white text-slate-900 flex flex-col p-6 sm:p-7 relative">
          <div className="flex items-start justify-between gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 h-9 px-3.5 rounded-full border border-slate-200 bg-white text-[11px] font-bold uppercase tracking-wider text-slate-700 hover:bg-slate-50 transition-colors"
            >
              Groups
                ...
                <>
                  ...
                  {active && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none px-6 text-center">
                      ...
                      />
                      <p className="text-[13px] text-slate-500 font-medium truncate max-w-full leading-tight">
                        {active.name}
                      </p>
                      <p className="text-[17px] font-bold text-slate-900 tabular-nums mt-0.5 leading-tight">
